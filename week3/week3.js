...
//   };
  ...
  // var product1 = productJSON[0];
  // let product_string= JSON.stringify(product1);
  ...
  // let phone_img = product_details.appendChild(product_img);
  // phone_img.classList.add("image");
  // product_img.width= product_parse.image.width;
  // product_img.height=product_parse.image.height;
  
  // let product_info = document.createElement("div");
  // product_details.classList.add("product_info");
  // //const product_title = document.createElement("div");
  // product_title = product_parse.title;
